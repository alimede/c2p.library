...
; s2p_8x6_mexg core procedure
; Scrambled 2 Planar conversion, 6 bit per pixel.
; a0 = scrambled buffer
; a1 = raster address
; d0 = num pixels to convert
; d1 = bitplane size
	public	_s2p_8x6_mexg_core
	cnop	0,4
_s2p_8x6_mexg_core:

	move.l	d1,a2			;bplsize in a2

	lea		(a1,d1.l),a6	;bpl1 ptr in a6
	lea		(a6,d1.l*2),a3	;bpl3 ptr in a3
