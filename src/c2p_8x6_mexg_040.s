...
; d3 = row modulo
	public	_c2p_8x6_mexg_040
	cnop	0,4
_c2p_8x6_mexg_040:
	push.l	a2

	lea		_c2p_8x6_mexg_040_core,a2
	bsr.w	_cs2p_8
...
; c2p_8x6_mexg_040 core procedure
; Chunky 2 Planar conversion, 6 bit per pixel.
; a0 = chunky buffer
; a1 = raster address
; d0 = num pixels to convert
; d1 = bitplane size
	public	_c2p_8x6_mexg_040_core
	cnop	0,4
_c2p_8x6_mexg_040_core:
...
mask_nibbles_3	equ	$C3C3C3C3
	...
	; superscalar interleaving, see before
	move.l	d4,(a3,a2.l*2)		;write bpl5
		;D4 = free for use
